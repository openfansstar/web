      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-24">
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 text-center">
            ...
            <p className="text-white/50 text-sm">{t('home.feature1.desc')}</p>
          </div>
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 text-center">
            ...
            <p className="text-white/50 text-sm">{t('home.feature2.desc')}</p>
          </div>
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10 text-center">
            ...
            <p className="text-white/50 text-sm">{t('home.feature3.desc')}</p>
          </div>
        </div>
      </section>
